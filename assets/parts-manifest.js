...
window.AVATAR_PARTS_MANIFEST = {
  categories: [
    ...
    { key: 'mandible', label: 'Mandibule', count: 7,  optional: true },
  ...
  // desactives ci-dessus : sans picker pour les choisir, cfg.object /
  // cfg.hat sont toujours null et donc simplement ignores au rendu (voir
